...
class _reviewsState extends State<reviews> {
  ...
  Future allreview(num pid) async {
    try{ response =await http.post(Uri.parse("http://10.0.2.2:5000/get_all_approved_comments/submit"),
      headers:<String, String>{'Content-Type': 'application/json; charset=UTF-8' ,},
      body:jsonEncode({ "Pid":pid, }, ), );
    print(response.body); _reviewList=json.decode(response.body);
    print(_reviewList?.length);
    print("ssssssss");
    }
